...
TEST_F(VectorTest, VectorTest2) {
    ...
    vector_.PushBack(2);
    vector_.PushBack(3);
    Vector<int> vec = Vector<int>(vector_);
    EXPECT_EQ(vec[1], 2);
}
...
TEST_F(VectorTest, VectorTest4) {
    ...
    vector_.PushBack(2);
    vector_.PushBack(3);
    Vector<int> vector2 = Vector<int>(10);
    vector2.PushBack(10);
    vector_ = vector2;
